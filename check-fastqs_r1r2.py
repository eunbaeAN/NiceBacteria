...
This file is from Bactopia. 
https://github.com/bactopia/bactopia/tree/master/modules/local/bactopia/gather_samples/bin
"""
...
def check_reads(fq1, sample, fq2=None):
